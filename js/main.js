...
// let favIcon = document.querySelectorAll(".favoriteIcon");
...
//     loadFavs();
//   } else {
//     // setTimeout to prevent page freeze
//     setTimeout(() => {
//       favIcon = document.querySelectorAll(".favoriteIcon");
//       START();
//     }, 100);
//   }
// }
...
//         if (!favorites.includes(element.dataset.id)) {
//           favorites.push(element.dataset.id);
//         }
//       } else {
//         favorites = favorites.filter((fav) => fav !== element.dataset.id);
//       }
